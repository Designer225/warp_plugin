...
* A previous build has FTL disabled, but it has since been re-enabled because the AI just. Doesn't. Know. How. To. Pathfind. Using. Only. Jump. Drives. Learn how to press J and plot jumps.
